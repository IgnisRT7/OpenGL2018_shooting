...
#define CRI_TESTPROJECT_ACF_NUM_CATEGORIES_PER_PLAYBACK (4)
#define CRI_TESTPROJECT_ACF_CATEGORYNUM (1)
#define CRI_TESTPROJECT_ACF_AISACCONTROLNUM (16)
#define CRI_TESTPROJECT_ACF_GLOBALAISACNUM (0)
#define CRI_TESTPROJECT_ACF_VOICELIMITGROUPNUM (1)
#define CRI_TESTPROJECT_ACF_DSPSETTINGNUM (1)
#define CRI_TESTPROJECT_ACF_DSPSETTINGSNAPSHOTNUM (0)
